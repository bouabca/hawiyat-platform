				...
				<div className="relative z-20 mt-auto">
					<blockquote className="space-y-2">
						<p className="text-lg text-primary">
							&ldquo;The new Selfhosted alternative to Vercel/Netlify/Heroku
							but even better , Embrace Hawiyat.&rdquo;
						</p>
					</blockquote>
				</div>
			</div>
			<div className="w-full">
				...
				<div className="flex items-center gap-4 justify-center absolute bottom-4 right-4 text-muted-foreground">
					<Button variant="ghost" size="icon">
						<Link href="https://hawiyat.org">
							<GithubIcon />
						</Link>
					</Button>
					<Button variant="ghost" size="icon">
						<Link href="https://www.linkedin.com/company/hawiyat/posts/">
							<svg
								stroke="currentColor"
								fill="currentColor"
								strokeWidth="0"
